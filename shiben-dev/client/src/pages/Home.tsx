...
export default function Home() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#f7f2e8] text-[#172f39]">
      ...
      <footer className="bg-[#172f39] px-5 py-8 text-[#c7d2cf] sm:px-8 lg:px-12"><div className="mx-auto flex max-w-[1440px] flex-col justify-between gap-5 text-sm sm:flex-row sm:items-center"><div className="flex items-center gap-3"><img src={imagePath("huawen-textbook-mark.svg")} alt="" className="h-8 w-8" /><span>识本 · 华文教材库</span></div><div className="leading-relaxed text-[#9bafae] sm:text-right"><a className="font-semibold tracking-[0.08em] hover:text-white" href={j4funHomeUrl}>J4FUN 出品</a><span className="block text-xs">Made with ❤️ (AI)</span></div></div></footer>
    </div>
  );
}
